...
"""
Multiples of Five - Print all te multiples of 5 from 5 to 1,000
...
"""
Counting, the Dojo Way - Print integers 1 o 100. If divisible by
...
"""
Whao. That Sucker's Huge - Add odd integers from 0 to 500,000, 
...
multiple of mult. For example, if lowNum=2, highNum=9, and mult=3, the 
